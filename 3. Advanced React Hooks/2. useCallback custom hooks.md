...
```
As this Hook has been written it'll run only once after the render of the component. This is a **not good solution** because if our `count` changes during the life of our component we will never save it to [[localStorage]].
